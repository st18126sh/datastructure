...
int main(void){
  ...
  root = addNode(root, 250);
  root = addNode(root, 10);
  root = addNode(root, 125);
  root = addNode(root, 5);
  root = addNode(root, 25);
  root = addNode(root, 500);
  root = addNode(root, 175);
  root = addNode(root, 501);
  root = addNode(root, 502);
  root = addNode(root, 503);
  root = addNode(root, 504);
  root = addNode(root, 505);
  root = addNode(root, 506);
